...
<head>
  ...
  <body>
      ...
      <header>
          ...
          <a href="studenthome.html">FACULTY PORTAL</a>
          <div class="logout">
            <a href="index.php">
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "SELECT * FROM tbl_faculty WHERE id = '$faculty_id' AND password = '$currentPassword' AND email = '$currentEmail'";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        if ($newPassword === $confirmNewPassword) {
            ...
            $updateSql = "UPDATE tbl_faculty SET password = '$newPassword', email = '$newEmail' WHERE id = '$faculty_id'";
