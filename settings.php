...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "SELECT * FROM tbl_student WHERE id = '$student_id' AND password = '$currentPassword' AND email = '$currentEmail'";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        if ($newPassword === $confirmNewPassword) {
            ...
            $updateSql = "UPDATE tbl_student SET password = '$newPassword', email = '$newEmail' WHERE id = '$student_id'";
